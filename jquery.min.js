...
var themeUrl = '/wp-content/themes/d7/';
//for herd power by WPSong
var zzjs = {
  shit: !-[1,] && !window.XMLHttpRequest,
	...
	doMove: function(obj, iTarget, callback) {
		...
		obj.timer = setInterval(function() {
			var iCur = zzjs.currentStyle(obj, "height"),
...
window.onload = function() {
	...
	oNav = document.getElementById("header-inner"),
	fnStatus = function(status) {
		!!status ?
		(function() {
			oNav.className = "hide";
			//zzjs.doMove(oTopBar, 4);
			zzjs.doMove(oNav, 30);
		})() :
		(function() {
			zzjs.doMove(oNav, 56, function() {
				this.className = ""	;
			})
		})();
	};
	zzjs.fixed(oWrap);//IE6 Fixed
	window.onscroll = function() {
		var iScrollTop = zzjs.scrollTop();
...
jQuery(document).ready(function($) {
	...
	$(document).click(function() {
		...
		$('.sbtn-headermenu').removeClass('btn-active');
	})
	$('.sbtn-headermenu,.popup-layer,.popup-arrow').click(function(event) {
		event.stopPropagation();
	})
	$('.sbtn-headermenu').each(function(){
		$(this).click(function(){
			$(this).toggleClass('sbtn-active');
			$(this).next().toggle();
